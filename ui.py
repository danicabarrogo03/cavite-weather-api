...
from config import COLORS, get_weather_info, get_bg_category, get_heat_index_status, get_weather_advice
...
class WeatherWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.city_selector.addItems(["Tanza", "Trece Martires", "Amadeo", "Indang"])
        ...
        # --- NEW: Notification / Advice Banner ---
